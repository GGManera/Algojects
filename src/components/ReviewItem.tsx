...
export function ReviewItem({ review, project, onInteractionSuccess, interactionScore, projectSourceContext, allCuratorData, focusedId, registerItem, isActive, setLastActiveId, globalViewMode }: ReviewItemProps) {
  ...
  return (
    ...
    >
      <div 
        className={cn(
          "w-full bg-gradient-to-r from-gradient-start to-gradient-end text-white rounded-lg overflow-hidden cursor-pointer transition-all duration-200 shadow-none", // Removed border-2 border-transparent
          "rounded-lg",
