...
export function StarRatingProgressBar({ average, scale, totalResponses }: StarRatingProgressBarProps) {
  ...
  return (
    <div className="flex flex-col space-y-2 items-center"> {/* Added items-center here */}
      
      {/* Wrapper for the star bar to ensure it takes only necessary width and is centered */}
      ...
      {/* Total responses text (now centered by the parent flex container) */}
