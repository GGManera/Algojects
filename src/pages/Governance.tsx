...
const CustomStarTick = (props: any) => {
  ...
  return (
    <g transform={`translate(${x},${y})`}>
      <text x={0} y={0} dy={16} textAnchor="middle" fill="#FFBB28" className="font-numeric text-[10px]"> {/* ADJUSTED to text-[10px] */}
        {payload.value}
      </text>
    </g>
  );
                                  ...
                                  <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                                    ...
                                    {qStats.type === 'rating' && (
                                        <ResponsiveContainer width="100%" height={200}>
                                            <BarChart data={qStats.data} margin={{ top: 5, right: 5, left: -5, bottom: 5 }}>
